...
func Example_basic() {
	...
	log.Formatter = new(sysadmLog.JSONFormatter)
	...
	log.Level = sysadmLog.TraceLevel
	log.Out = os.Stdout

	// file, err := os.OpenFile("sysadmLog.log", os.O_CREATE|os.O_WRONLY, 0666)
	// if err == nil {
	// 	log.Out = file
	// } else {
